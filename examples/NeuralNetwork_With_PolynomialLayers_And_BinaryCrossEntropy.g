...
#linear_layer_1 := Para.PolynomialLayer( input_size, hidden_size_1, 2 );
#relu_1 := Para.Relu( hidden_size_1 );

#linear_layer_2 := Para.PolynomialLayer( hidden_size_1, hidden_size_2, 1 );
#relu_2 := Para.Relu( hidden_size_2 );

linear_layer_3 := Para.PolynomialLayer( input_size, output_size, 2 );
